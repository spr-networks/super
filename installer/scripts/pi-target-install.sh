...
fdtoverlay -i /mnt/boot/firmware/bcm2712-rpi-5-b.dtb -o /mnt/boot/firmware/bcm2712-rpi-5-b.dtb /mnt/boot/firmware/overlays/pcie-32bit-dma-pi5.dtbo
echo "dtparam=pciex1" >> /mnt/boot/firmware/config.txt
